...
import banner from '/banners/cover3.jpg'
    ...
    let toggleBanner = toogleMenu ? (<div className={css.banner}>
        ...
        <div className={css.bannerInner}>
            ...
            <div className={css.bannerTxt}>
                <div className={css.title}>Ноён Хаус</div>
                <div className={css.tag}>Мэргэжлийн, туршлагатай хамт олон<span className={css.bld}> тань хүрнэ</span></div>
