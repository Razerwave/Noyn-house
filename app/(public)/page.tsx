...
import { faqs, models, processSteps, projects } from "@/lib/data";
    ...
    <>
      <section className="hero">
        <div className="container hero-content">
          ...
          <h1>Гэр бүлийн<br />ирээдүйг барина</h1>
      ...
      <section className="section"><div className="container"><div className="section-head"><div><div className="eyebrow">Ажлын дараалал</div><h2 className="section-title">Санаанаас түлхүүр гардуулах хүртэл</h2></div><Link className="text-link" href="/process">Дэлгэрэнгүй явц <ArrowRight size={16}/></Link></div><div className="process-grid">{processSteps.slice(0,6).map((step,i)=><div className="process-item" key={step}><b>{String(i+1).padStart(2,'0')}</b><h3>{step}</h3><p>Тухайн үе шатны үр дүн, хариуцагч, дараагийн алхмыг хамтдаа баталгаажуулна.</p></div>)}</div></div></section>
