  ...
  return (
    <footer className="footer">
      <div className="container footer-grid">
        ...
        <div><h4>Холбоо барих</h4><a href={`tel:${phoneHref}`}><Phone size={15} /> {settings.phone}</a><a href={`mailto:${settings.email}`}><Mail size={15} /> {settings.email}</a><span><MapPin size={15} /> {settings.address}</span></div>
